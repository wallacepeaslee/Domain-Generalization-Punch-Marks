...
def runValidExperiment(trainTxtFilePath, validTxtFilePath, mcbTxtFilePath, FitzTxtFilePath, CologneTxtFilePath, MicroscopyTxtFilePath, savePath, trialNums):    
    ...
    trainSet = CustomDataset(trainTxtFilePath, transform = augment_transform)
    ...
    numFeaturesDefault = model_ft.classifier.in_features
    
    model_ft.classifier = nn.Linear(numFeaturesDefault, numClasses)
...
if __name__ == "__main__":
    ...
    '''
    TODO: update the train filepaths below
    '''
    trainFilePaths = ['sfa_train_split0.txt',
                      'sfa_train_split1.txt',
                      'sfa_train_split2.txt']
    validFilePaths = ['sfa_valid_split0.txt',
                      'sfa_valid_split1.txt',
                      'sfa_valid_split2.txt']
    
    
    '''
    TODO: update the test filepaths below
    '''
    mcbFilePath = 'mcb_test_sfa.txt'
    ...
    '''
    TODO: update the below, a folder path where output information should be saved.
    '''
    outputSavePath = ''
