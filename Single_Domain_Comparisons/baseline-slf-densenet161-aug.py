...
if __name__ == "__main__":
    ...
    '''
    trainFilePaths = ['slf_train_split0.txt',
                      'slf_train_split1.txt',
                      'slf_train_split2.txt']
    validFilePaths = ['slf_valid_split0.txt',
                      'slf_valid_split1.txt',
                      'slf_valid_split2.txt']
    
    
    '''
    TODO: update the test filepaths below
    '''
    mcbFilePath = 'mcb_test_slf.txt'
